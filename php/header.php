 <img src="assets/img/mcoe-transformed.png" height=70px" style="height:120px" />
             ...
             <ul>
                 ...
                 <li class="dropdown"><a href="login.php"><span>Login</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>
                         ...
                         <li><a href="admin/index.php">Department Login</a></li>
                         <li><a href="login-candidates.php">Student Login</a></li>
                         <li><a href="login-company.php">Employer Login</a></li>
